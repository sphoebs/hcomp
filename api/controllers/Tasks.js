      ...
      case recentTasksByAssignments:
        pool.connect((err, client, done) => {
          if (err) {
            ...
            const query = `SELECT distinct t.*,  a."createdAt" FROM tasks AS t INNER JOIN assignments AS a ON t.id=a.id_task ORDER BY a."createdAt" DESC LIMIT 4 GROUP BY t.id;`;
